...
const ASSUMPTIONS = [
  ...
  { id: 4,  text: 'Named pipeline drives bookings months 1–6; sales capacity drives bookings months 7–18. No overlap.' },
  ...
  { id: 9,  text: 'No FX, no taxes, no SBC line item. Operating income is pre-SBC, pre-tax.' },
