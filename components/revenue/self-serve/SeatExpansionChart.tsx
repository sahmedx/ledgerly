    ...
    <div className="sketch-box" style={{ padding: '14px 18px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 6 }}>
        ...
        <div style={{ display: 'flex', gap: 12, fontSize: 11, color: 'var(--ink-3)' }}>
          <LegendSwatch shape="line" color="var(--accent-cool)" label="Plus" />
          <LegendSwatch shape="line" color="var(--accent-good)" label="Business (small)" />
          <LegendSwatch shape="line" color="var(--ink-4)" label={`Graduation · ${threshold} seats`} dashed />
        </div>
      </div>
