...
export const CONSOLIDATED_LINES: LineItem[] = [
  ...
  { id: 'sm_sbc', label: 'S&M stock-based comp', indent: 2, style: 'subsub', kind: 'money',
    accessor: p => p.sm_sbc },
  { id: 'sm_programs', label: 'S&M programs', indent: 2, style: 'subsub', kind: 'money',
  ...
  { id: 'rd_sbc', label: 'R&D stock-based comp', indent: 2, style: 'subsub', kind: 'money',
    accessor: p => p.rd_sbc },
  { id: 'rd_tooling', label: 'R&D tooling', indent: 2, style: 'subsub', kind: 'money',
  ...
  { id: 'ga_sbc', label: 'G&A stock-based comp', indent: 2, style: 'subsub', kind: 'money',
    accessor: p => p.ga_sbc },
  { id: 'ga_te', label: 'G&A T&E', indent: 2, style: 'subsub', kind: 'money',
    accessor: p => p.ga_te },
